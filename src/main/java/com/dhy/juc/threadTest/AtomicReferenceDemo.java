package com.dhy.juc.threadTest;/**
...
public class AtomicReferenceDemo {
    ...
    static class MyRun1 implements Runnable {
        ...
        public void run() {
            ...
            System.out.println("\n" + Thread.currentThread().getName() +" Atomic References " + message + " - " + person.toString());
    ...
    static class MyRun2 implements Runnable {
        ...
        public void run() {
            ...
            System.out.println("\n" + Thread.currentThread().getName() +" Atomic References: " + aRmessage.get() + " - " + aRperson.get().toString());
