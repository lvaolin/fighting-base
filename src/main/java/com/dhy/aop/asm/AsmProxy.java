...
public class AsmProxy {
    ...
    private static void redefineHelloClass() {
        String className = "com.dhy.aop.asm.HelloWorld";
        try {
            InputStream inputStream = new FileInputStream("C:\\code_github\\idcreateservice\\target\\classes\\com\\asm\\HelloWorld.class");
            ...
            try {
                // 将二进制流写到本地磁盘上
                FileOutputStream fos = new FileOutputStream("C:\\code_github\\idcreateservice\\target\\classes\\com\\asm\\HelloWorld2.class");
                fos.write(code);
                fos.close();
            } catch (IOException e) {
                e.printStackTrace();
